/*==============================================================================
  ...
  Description: This file contains the class Card which maintains the state
               information of a traditional vegas style playing card.  A Card 
	       has a Suit and Value, both expressed as enums.
...
namespace hw2
{
  ...
  private:
    ...
    SuitMap suitToStr = { {Suit::SPADES, "Spades"},
			  {Suit::CLUBS, "Clubs"},
			  {Suit::HEARTS, "Hearts"},
			  {Suit::DIAMONDS, "Diamonds"} };
    
    
    RankMap rankToStr = { {Rank::ACE, "Ace"},
			  {Rank::TWO, "2"},
			  {Rank::THREE, "3"},
			  {Rank::FOUR, "4"},
			  {Rank::FIVE, "5"},
